...
class CustomEmissionNoiseModel(QuantumErrorModel):
    ...
    def error_operation(self, qubits, delta_time=0, **properties):
        ...
        """
        # print("Qubit in Emission Noise Model", qubits[0].qstate.qrepr, qubits[0].name, ns.sim_time())
        # print("All qubits in emission noise model", qubits[0].qstate.qubits, qubits[0].qstate.qubits[1])
